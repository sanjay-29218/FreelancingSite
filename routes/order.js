...
// router.post("/checkout/single_package/:id" , async(req,res,next)=>{
//     try{
...
//         res.send(newOrder)
//         res.redirect('/users/:id/manage_orders')
...
router.post("/checkout/single_package/:id" ,(req, res, next) => {
        const _id = req.params.id;
        var gig = req.session.gig;
